...
_START_JOB: dict[str, Any] = {
    ...
    "description": (
        ...
        "[per_chromosome, chromosomes]) -- set per_chromosome=true (with chromosomes like "
        "\"1-22\") to run COJO one chromosome at a time when the reference panel is too large "
        "to load whole into RAM; result is identical to a genome-wide run\n"
